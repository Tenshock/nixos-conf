...
let
  mochaTheme = pkgs.fetchurl {
    url =
      "https://raw.githubusercontent.com/catppuccin/lazygit/21a25afd92327ddea8446ab9171ca7039b431e9e/themes-mergable/mocha/yellow.yml";
...
in {
  ...
  home = {
    ...
    sessionVariables.LG_CONFIG_FILE =
      let lazygitConfig = "${config.xdg.configHome}/lazygit";
      in "${lazygitConfig}/config.yml,${lazygitConfig}/mocha.yml";
  };
